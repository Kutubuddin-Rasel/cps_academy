                ...
                <div className="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 text-white py-16">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="flex items-center gap-4 flex-wrap">
                            <div className="bg-white text-indigo-600 px-4 py-2 rounded-full font-semibold shadow-lg">
                                👤 {user.role?.name || 'User'}
                            </div>
                            <div className="bg-white text-purple-600 px-4 py-2 rounded-full font-semibold shadow-lg">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {accessibleCourses.map((course) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            {/* THIS IS THE KEY CHANGE - Check for thumbnail */}
                                            {thumbnailUrl ? (
