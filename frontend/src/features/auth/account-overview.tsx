    ...
    <div className="max-w-3xl space-y-6">
      <section aria-labelledby="account-details" className="border-y border-slate-200 bg-white">
        ...
        <dl className="divide-y divide-slate-200">
          ...
          <div className="grid min-w-0 gap-1 py-5 sm:grid-cols-[10rem_minmax(0,1fr)] sm:gap-8"><dt className="text-sm text-slate-600">LMS role</dt><dd className="font-medium">{user.role ?? "No LMS role assigned"}</dd></div>
        </dl>
      </section>
      {user.role === null ? (
